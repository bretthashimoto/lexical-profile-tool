...
7. Add a button for languages
8. Have lemmatization be on by default
9. Have a better default example
10. Add a tutorial to the interface
11. Get rid of the minimum token length option
12. ~~Add a better looking title~~ (done)
13. ~~Change the title to "Leah"~~ (done)
14. ~~Create a better logo for the app~~ (done)
15. Add info about me in a tab
16. Add info about how to cite this in a tab
